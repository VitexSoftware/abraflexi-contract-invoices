...
**Purpose**: ![app logo](abraflexi-contract-invoices.svg?raw=true)
**Status**: Active
**Repository**: git@github.com:VitexSoftware/abraflexi-contract-invoices.git
...
git clone git@github.com:VitexSoftware/abraflexi-contract-invoices.git
cd abraflexi-contract-invoices
